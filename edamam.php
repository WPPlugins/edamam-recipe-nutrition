...
if (!defined('EDAMAM_RECIPE_VERSION_NUM'))
    define('EDAMAM_RECIPE_VERSION_NUM', '3.3'); //!!mwp
...
function edamam_recipe_format_recipe($recipe) { //!!mwp
  global $wpdb;
	...
	$output .= '
        ...
        if($logo == "yes"){
          $logostr = '<span style="float:right;"><a target="_blank" href="https://developer.edamam.com/"><img src="' . EDAMAM_RECIPE_PLUGIN_DIRECTORY . 'edamam-logo-plugin.png" class="edamam-img"></a></span>';
        } 
